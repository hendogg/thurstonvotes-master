...
class App extends Component {
  ...
  state = {
    links: [
      {title:'Votes', url: eResults, img: results, title: 'Election Results' },
      ...
      {title:'Votes', url: eNeedBallot, img: needBallot, title: 'Election Dates' },
      {title:'Votes', url: eElectionDates, img: electionDates, title: 'Elected Officials' },
      {title:'Votes', url: eDistElect, img: distElect, title: 'Election Results'},

      {title:'Votes', url: eMaps, img: maps, title: 'Presinct Maps' },
