...
var HeaderBackButton=function HeaderBackButton(_ref){var onPress=_ref.onPress,title=_ref.title,tintColor=_ref.tintColor;return(
...
_react2.default.createElement(_reactNative.Text,{style:[styles.title,{color:tintColor}]},
title))));};
