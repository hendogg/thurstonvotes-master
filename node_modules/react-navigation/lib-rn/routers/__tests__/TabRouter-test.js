...
var ScreenB=function ScreenB(){return _react2.default.createElement('div',null);};
var router=(0,_TabRouter2.default)({
Foo:{getScreen:function getScreen(){return ScreenA;}},
Bar:{getScreen:function getScreen(){return ScreenB;}}});
...
var router=(0,_TabRouter2.default)({Foo:BareLeafRouteConfig,Bar:BareLeafRouteConfig});
var state=router.getStateForAction({type:_NavigationActions2.default.NAVIGATE,routeName:'Foo'});
expect(state&&state.index).toEqual(0);
});

test('Handles nested tabs and nested actions',function(){
var ChildTabNavigator=function ChildTabNavigator(){return _react2.default.createElement('div',null);};
ChildTabNavigator.router=(0,_TabRouter2.default)({Foo:BareLeafRouteConfig,Bar:BareLeafRouteConfig});
var router=(0,_TabRouter2.default)({Foo:BareLeafRouteConfig,Baz:{screen:ChildTabNavigator},Boo:BareLeafRouteConfig});
var action=router.getActionForPathAndParams('Baz/Bar',{foo:'42'});
var navAction={type:_NavigationActions2.default.NAVIGATE,routeName:'Baz',action:{type:_NavigationActions2.default.NAVIGATE,routeName:'Bar',params:{foo:'42'}}};
...
ChildTabNavigator.router=(0,_TabRouter2.default)({Foo:BareLeafRouteConfig,Bar:BareLeafRouteConfig});
var router=(0,_TabRouter2.default)({Foo:BareLeafRouteConfig,Baz:{screen:ChildTabNavigator},Boo:BareLeafRouteConfig});
var state=router.getStateForAction({type:_NavigationActions2.default.NAVIGATE,routeName:'Bar'});
expect(state).toEqual({
index:1,
routes:[
...
var ChildNavigator0=function ChildNavigator0(){return _react2.default.createElement('div',null);};
ChildNavigator0.router=(0,_TabRouter2.default)({Boo:BareLeafRouteConfig,Baz:BareLeafRouteConfig});
var ChildNavigator1=function ChildNavigator1(){return _react2.default.createElement('div',null);};
ChildNavigator1.router=(0,_TabRouter2.default)({Zoo:BareLeafRouteConfig,Zap:BareLeafRouteConfig});
var MidNavigator=function MidNavigator(){return _react2.default.createElement('div',null);};
MidNavigator.router=(0,_TabRouter2.default)({Foo:{screen:ChildNavigator0},Bar:{screen:ChildNavigator1}});
var router=(0,_TabRouter2.default)({Foo:{screen:MidNavigator},Gah:BareLeafRouteConfig});
...
expect(state3).toEqual(null);
var state4=router.getStateForAction({type:_NavigationActions2.default.NAVIGATE,routeName:'Foo',action:{type:_NavigationActions2.default.NAVIGATE,routeName:'Bar',action:{type:_NavigationActions2.default.NAVIGATE,routeName:'Zap'}}});
...
var action=router.getActionForPathAndParams('b/anything',{foo:'42'});
var expectedAction={
params:{
foo:'42'},
